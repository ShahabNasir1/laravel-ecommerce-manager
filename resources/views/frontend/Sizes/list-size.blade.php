...
<script>
    $(document).ready(function() {
        ...
        // 1. CLICK LISTENER FOR EDIT MODAL (Fetches data dynamically)
        ...
        // 2. SUBMIT LISTENER FOR EDIT FORM (AJAX PUT Update)
        ...
        // 3. CLICK LISTENER FOR DELETE MODAL
        $(document).on('click', '.btn-delete', function() {
            ...
            $('#deleteColorForm').attr('action', deleteRoute); // Backward safety check
            $('#deleteSizeForm').attr('action', deleteRoute);
            $('#deleteModal').modal('show');
        });

        // 4. SUBMIT LISTENER FOR DELETE FORM (AJAX DELETE Engine)
